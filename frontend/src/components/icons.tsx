...
export const BuildingIcon: React.FC<IconProps> = ({ size = 16, className = '', ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const AwardIcon: React.FC<IconProps> = ({ size = 16, className = '', ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const KeyIcon: React.FC<IconProps> = ({ size = 16, className = '', ...props }) => (
  <svg
    ...
    {...props}
  >
    <path d="M21 2l-2 2m-1.5 1.5L14 9.5a5.5 5.5 0 1 0 4.5 4.5l6-6V5h-3V2h-3z"></path>
